      ...
      <div>
        <div className="flex md:mr-[60px] md:m-0 m-[10px] gap-[25px] md:mt-[110px] flex-col text-white">
          ...
          <div className="flex gap-[25px] md:mb-0 mb-[120px]">
            <div><Image src='/child1.png' width={322} height={194} alt="hero-egg" className="rounded-[6px]"/></div>
            <div><Image src='/child2.png' width={322} height={194} alt="hero-egg" className="rounded-[6px]"/></div>
          </div>
        </div>
      </div>
    </div>
